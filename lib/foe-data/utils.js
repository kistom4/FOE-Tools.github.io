...
const defaultCost = [
  ...
  { cost: 3943, reward: generateReward(875) },
  { cost: 4041, reward: generateReward(890) },
  { cost: 4142, reward: generateReward(900) },
  { cost: 4246, reward: generateReward(915) },
  { cost: 4352, reward: generateReward(925) },
  { cost: 4461, reward: generateReward(940) },
  { cost: 4572, reward: generateReward(950) },
  { cost: 4687, reward: generateReward(965) },
  { cost: 4804, reward: generateReward(975) },
  { cost: 4924, reward: generateReward(990) },
  { cost: 5047, reward: generateReward(1005) },
  { cost: 5173, reward: generateReward(1015) },
  { cost: 5303, reward: generateReward(1030) },
  { cost: 5435, reward: generateReward(1040) },
  { cost: 5571, reward: generateReward(1055) },
  { cost: 5710, reward: generateReward(1070) },
  { cost: 5853, reward: generateReward(1080) },
  { cost: 5999, reward: generateReward(1095) },
  { cost: 6149, reward: generateReward(1110) },
  { cost: 6303, reward: generateReward(1120) },
  { cost: 6461, reward: generateReward(1135) },
